...
# Cloned from build/tools/mktarball.sh with patch to fix incorrect file permission
# caused by -print in find command, which results in prefixing ./ to file paths.
# And this preceding ./ cause fs_get_stats outputs wrong permission bits, e.g.
# executables lose execution bits.
